...
import HeroCertificateDetails from "../../components/heroCertificates/HeroCertificateDetails";
import ComponentCard from "../../components/common/ComponentCard";
import PageBreadcrumb from "../../components/common/PageBreadCrumb";
import { Link } from "react-router";

export default function HeroCertificateDetailsPage() {
    return (
        <>
            <PageMeta
                title="Sertifikat redaktəsi | AzTU Admin"
                description="aztu.edu.az üçün idarəetmə paneli"
            />
            <PageBreadcrumb pageTitle="Sertifikat redaktəsi" />
            <ComponentCard
                title="Sertifikat redaktəsi"
                desc="Ana səhifə sertifikatının məlumatlarını yeniləyin"
                actions={
                    <Link
                        to="/hero-certificates"
