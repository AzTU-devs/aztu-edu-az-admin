...
import NewHeroCertificate from "../../components/heroCertificates/NewHeroCertificate";
import ComponentCard from "../../components/common/ComponentCard";
import PageBreadcrumb from "../../components/common/PageBreadCrumb";
import { Link } from "react-router";

export default function NewHeroCertificatePage() {
    return (
        <>
            <PageMeta
                title="Yeni sertifikat | AzTU Admin"
                description="aztu.edu.az üçün idarəetmə paneli"
            />
            <PageBreadcrumb pageTitle="Yeni sertifikat" />
            <ComponentCard
                title="Yeni sertifikat"
                desc="Ana səhifədə göstərilən yeni QS sertifikatı əlavə edin"
                actions={
                    <Link
