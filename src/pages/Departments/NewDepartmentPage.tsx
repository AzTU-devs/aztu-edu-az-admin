...
export default function NewDepartmentPage() {
  return (
    <>
      <PageMeta title="Yeni departament | AzTU Admin" description="aztu.edu.az üçün idarəetmə paneli" />
      <PageBreadcrumb pageTitle="Yeni departament" />
      <ComponentCard
        title="Yeni departament"
        desc="Yeni departament əlavə edin"
        actions={
          <Link
